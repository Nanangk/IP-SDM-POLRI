...
@section('content')
    <div class="bg-white rounded-xl shadow p-6">
        <div class="mb-6">
            <h2 class="text-2xl font-bold">Edit Komponen IP SDM Personel</h2>
            <p class="text-gray-600">Ubah data Komponen IP SDM Personel yang sudah tersimpan.</p>
        </div>
        ...
        <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="nrp" value="{{ old('nrp', $pegawai->nrp) }}"
                    class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
            </div>
            ...
            <div>
                ...
                <input type="text" name="satuan_kerja" value="{{ old('satuan_kerja', $pegawai->satuan_kerja) }}"
                    class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="kinerja_semester_1"
                        value="{{ old('kinerja_semester_1', $pegawai->kinerja_semester_1) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="kinerja_semester_2"
                        value="{{ old('kinerja_semester_2', $pegawai->kinerja_semester_2) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="disiplin"
                        value="{{ old('disiplin', $pegawai->disiplin) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="kesehatan"
                        value="{{ old('kesehatan', $pegawai->kesehatan) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="rohani_semester_1"
                        value="{{ old('rohani_semester_1', $pegawai->rohani_semester_1) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="rohani_semester_2"
                        value="{{ old('rohani_semester_2', $pegawai->rohani_semester_2) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="emental_semester_1"
                        value="{{ old('emental_semester_1', $pegawai->emental_semester_1) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="emental_semester_2"
                        value="{{ old('emental_semester_2', $pegawai->emental_semester_2) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="jasmani_semester_1"
                        value="{{ old('jasmani_semester_1', $pegawai->jasmani_semester_1) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="jasmani_semester_2"
                        value="{{ old('jasmani_semester_2', $pegawai->jasmani_semester_2) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
                ...
                <div>
                    ...
                    <input type="number" step="0.01" min="0" max="100" name="akademik"
                        value="{{ old('akademik', $pegawai->akademik) }}"
                        class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring focus:ring-blue-200">
                </div>
            </div>
    ...
    <p class="text-sm text-gray-500 mt-3">
        Nilai IP Personel akan dihitung otomatis oleh sistem setelah data disimpan.
            ...
            @if ($pegawai->foto)
                <div>
                    <label class="block mb-1 font-medium">Foto Saat Ini</label>
